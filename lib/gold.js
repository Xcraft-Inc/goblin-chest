...
class Gold extends Elf {
   ...
   *
   * This quest should be used only by the GoldWarden. It's purpose is to
  ...
  async update(data) {
    ...
    // TODO: check if the warden is running, just write the file in the repository if yes
    ...
    //       server → juste write file in the repository
